      ...
      <div className="bg-surface p-8 rounded-3xl border border-border w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-300">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                {...register("email")}
                type="email" 
                className={`w-full bg-background border rounded-xl py-3 pl-10 pr-4 text-textMain focus:outline-none transition-colors ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className={`w-full bg-background border rounded-xl py-3 pl-10 pr-10 text-textMain focus:outline-none transition-colors ${
        ...
        <div className="mt-8 pt-6 border-t border-border text-center">
          <p className="text-textMuted text-sm">
            ...
            <Link to="/register" className="text-textMain font-bold hover:underline transition-colors">
              Sign Up
            </Link>
          </p>
        </div>
